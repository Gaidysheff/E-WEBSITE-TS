...
const ru: BaseTranslation = {
  ...
  auth: {
    ...
    passwordMin: "Пароль должен состоять как минимум из 8 символов",
    ...
    mustField: "Поле обязательно",
    tooLong: "Эл. адрес слишком длинный (RFC допускает до 254 символов)",
  },
  ...
  profile: {
    ...
    emailChange: {
      btn: "Подтвердить",
      loading: "Высылаем Вам письмо ...",
      title: "Смена эл. почты / логина",
      attention: "Внимание!",
      infoBefore:
      ...
      infoAfterB: "перейти по ссылке",
      infoAfterC: "для верификации вашего нового адреса.",
      infoAfterII:
        "После верификации вход в личный кабинет будет возможен уже только по новому электронному адресу.",
      emailChangeBtn: "Изменить эл.почту",
      email: "Электронная почта",
      emailPlaceholder: "ваша новая электронная почта",
      password: "Пароль",
      passwordPlaceholder: "ваш текущий пароль",
      success: "На новый адрес отправлено письмо для верификации",
      ...
      verification: {
        ...
        login: "Авторизоваться",
        error: "Ошибка!",
        noToken: "Токен недействителен или срок его действия истек.",
      },
    },
  },
  successPage: {
