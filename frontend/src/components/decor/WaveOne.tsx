...
const WaveOne = ({ className }: Props) => {
  return (
    ...
    //   className={cn(
    //     "relative block w-full h-[100px] sm:h-[200px] lg:h-[300px]",
    //     className,
    //   )}
    // >
    ...
    <svg
      viewBox="0 0 1440 320"
      preserveAspectRatio="none"
      className={cn("relative block w-full h-[50px] sm:h-[200px]", className)}
      // Ссылка на градиент. Если класс цвета передан, он может перебить этот fill,
      // поэтому если нужен ТОЛЬКО градиент, класс fill-... в пропсах передавать не нужно.
