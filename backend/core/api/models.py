...
class CustomerAddress(models.Model):
    ...
    state = models.CharField(max_length=50, default="Россия", blank=True, null=True)
...
class DeliveryOption(AutoTranslationMixin, models.Model):
    ...
    icon = models.ImageField(
        ...
        null=True,
        blank=True,
        verbose_name="Загрузить иконку",
    )
    price = models.DecimalField(
        max_digits=10, decimal_places=2, default=0.00, verbose_name="Стоимость"
    )
    is_active = models.BooleanField(default=True, verbose_name="Активен")
    is_pickup = models.BooleanField(default=False, verbose_name="Это самовывоз?")
