...
#             success_url=f"{BASE_URL_FRONTEND}success",
#             cancel_url=f"{BASE_URL_FRONTEND}failed",
#             # success_url=BASE_URL_FRONTEND + "success",
#             # cancel_url=BASE_URL_FRONTEND + "failed",
#             # success_url="https://eshop-xi-green.vercel.app/success",
#             # cancel_url="https://eshop-xi-green.vercel.app/failed",
#             metadata={"cart_code": cart_code},
#         )
#         return Response({"data": checkout_session})
#     except Exception as e:
